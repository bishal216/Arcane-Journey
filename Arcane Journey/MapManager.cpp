...
MapManager::MapManager() :
	coin_animation(CELL_SIZE, "../assets/textures/Coin.png", COIN_ANIMATION_SPEED),
	question_block_animation(CELL_SIZE, "../assets/textures/QuestionBlock.png", QUESTION_BLOCK_ANIMATION_SPEED)
{
	map_texture.loadFromFile("../assets/Images/Map.png");
...
{
	map_sketch.loadFromFile("../assets/Images/LevelSketch" + std::to_string(static_cast<unsigned short>(i_current_level)) + ".png");
}

...
int main()
{
	//Using unsigned char instead of int saves space
	...
	sf::Event event;
	sf::RenderWindow window(sf::VideoMode(SCREEN_RESIZE * SCREEN_WIDTH, SCREEN_RESIZE * SCREEN_HEIGHT), "Arcane Journey", sf::Style::Close);
